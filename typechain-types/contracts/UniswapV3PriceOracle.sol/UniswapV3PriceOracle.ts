...
export interface UniswapV3PriceOracle extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV3PriceOracle;
  waitForDeployment(): Promise<this>;

  interface: UniswapV3PriceOracleInterface;
